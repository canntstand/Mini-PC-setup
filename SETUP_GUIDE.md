...
## 1. Развертывание Amnezia VPN (на внешнем VPS)
...
6. После установки подключиться к созданному VPN и поделиться конфигурационным ключом/QR-кодом с нужными устройствами.
