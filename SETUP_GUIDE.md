...
5. Перейти в браузере по `http://127.0.0.1:3002` в WireGuard панель. Cоздать всех клиентов (в зависимости от того сколько устройств планируется подключить к VPN).
